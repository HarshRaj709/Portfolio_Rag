...
June 2022 – June 2025 | CGPA: 7.95 / 10.0 | Graduated
...
### SDE-1 – ScaleReal Technologies Pvt Ltd  
August 2025 – Present | 4+ months  
- Promoted to full-time SDE-1 after internship  
- Building production-grade backend services with Django & AI  
- Worked on a real-world carbon trading platform 
- Implemented real-time trading features using Django Channels and Django Signals.

---

### Backend Intern – ScaleReal Technologies Pvt Ltd  
February 2025 – July 2025 | 6 months  
- Designed and deployed RESTful APIs for core product  
- Integrated real-time features using Django Channels + Redis  
- Contributed to AI module using RAG and vector search  

---

### Python Backend Intern – App Genesis Soft Solutions  
August 2024 – October 2024 | 3 months  
- Built secure APIs and optimized database queries  
...
- Developed chatbot with IBM Watson Assistant  
- Deployed full solution on IBM Cloud  
...
## Skills Matrix (Vector-Optimized)

| Category | Technologies |
|--------|--------------|
| Backend | Python, Django, DRF, Channels |
| AI | RAG, MCP, Gemini, LangChain, IBM Watson |
| Realtime | WebSockets, Redis, ASGI |
| Database | PostgreSQL, Supabase pgvector, SQLite |
| Cloud | Render.com, Railway.app, IBM Cloud, Docker |
| Auth | Google OAuth, GitHub OAuth |
| Frontend | Bootstrap 5, HTML5, CSS3, JavaScript |
| Tools | Postman, Git, GitHub, CKEditor, Markdown |

---

## Quick Answers (For RAG Bot)

| Question | Answer |
|--------|--------|
| Current job? | SDE-1 @ ScaleReal Technologies (Aug 2025 – Present) |
| Internship? | 6 months at ScaleReal (Feb–Jul 2025) | 3 months at App Genesis Soft Solutions (Aug–Oct 2024) | 6 months at Edunet Foundation (June-July 2024)|
| CGPA? | 7.95 / 10.0 |
